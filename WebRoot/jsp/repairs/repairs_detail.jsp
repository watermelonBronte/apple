...
td {
	...
	-->
		<table align="center" border="1" cellpadding="4" cellspacing="0"
			...
			<tr align="center">
				<td colspan="7"
					style="font-family: @ Adobe 宋体 Std L; font-size: 25px; background-color: #A2B5CD; color: #fff"">
					维修单详情
				</td>
			</tr>
	...
	维修中
			...
			<tr>
				<td align="center" colspan="6" height="25" nowrap="nowrap">
					&nbsp;
					<font face="宋体"> <a href="javascript:history.back();"><span
							style="color: #0000ff; text-decoration: underline">返回</span>
					</a>
					</font>
				</td>
			</tr>
