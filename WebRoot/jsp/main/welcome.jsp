...
.font {
	...
	window.onload = function() {
		...
		var oDiv = document.getElementById('getdate');
		oDiv.innerHTML = year + "年" + month + "月" + day + "日。";
	...
	<body>
		...
		<marquee direction=left>
			<span class="font">${loginUname}</span><span style="color: black">，您好！欢迎光临资产管理系统,今天是</span><span
				id='getdate' class="font"></span>
		</marquee>
	  ...
	  <button class='dashed thick'>Dashed Thick</button>
				...
				<button class='dotted thin'>
					<p>
						<span style="color: #CD5555">项目名称：</span><span style="">资产管理系统</span>
					</p>
					<p style="text-align: left">
						<span style="color: #CD5555">组长</span>
						</br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;叶慧娟
						150327026
						</br>
						<span style="color: #CD5555">小组成员</span>
						</br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;杨铮
						&nbsp;&nbsp; 150327025
					</p>
	...
	-->
			...
			<svg version="1.1" id="clock" xmlns="http://www.w3.org/2000/svg"
				...
				width="200px" height="200px" viewBox="94.257 101.184 300 300"
	...
	C379.527,325.719,318.791,386.455,243.869,386.455z" />
			...
			<text transform="matrix(1 0 0 1 282 174.4307)" fill="#303030"
				font-family="'Futura-Medium'" font-size="26">
			1
			</text>
